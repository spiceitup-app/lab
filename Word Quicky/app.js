const LEVELS = {
  spicy: [
    { id:1, name:'Soft', description:'Null intime & sensible Inhalte', img:'Assets/Spicy_Level 1.png', top:'#329BFF', bottom:'#238CF0', accent:'#238CF0' },
    { id:2, name:'Direkt', description:'Leicht intime & sensible Themen', img:'Assets/Spicy_Level 2.png', top:'#6E00FA', bottom:'#5A00E6', accent:'#5A00E6' },
    { id:3, name:'Schonungslos', description:'Stark intime & sensible Themen', img:'Assets/Spicy_Level 3.png', top:'#FA0AFF', bottom:'#E100E6', accent:'#E100E6' }
  ],
  suff: [
    { id:1, name:'Chillig', img:'Assets/Suff_Level 1.png', top:'#329BFF', bottom:'#238CF0', accent:'#238CF0' },
    { id:2, name:'Party', img:'Assets/Suff_Level 2.png', top:'#6E00FA', bottom:'#5A00E6', accent:'#5A00E6' },
    { id:3, name:'Abriss', img:'Assets/Suff_Level 3.png', top:'#FA0AFF', bottom:'#E100E6', accent:'#E100E6' },
    { id:4, name:'Blackout', img:'Assets/Suff_Level 4.png', top:'#FF0A69', bottom:'#EB0055', accent:'#E50055' }
  ]
};
...
const savedSpicy = Number(localStorage.getItem('wordQuicky.spicyLevel'));
const savedSuff = Number(localStorage.getItem('wordQuicky.suffLevel'));
const savedExperimentalSuff = localStorage.getItem('wordQuicky.experimentalSuff');
...
function selectLevel(kind,id){
  if(kind === 'spicy') {
    state.spicyLevel = id;
    localStorage.setItem('wordQuicky.spicyLevel',String(id));
  } else {
    state.suffLevel = id;
    localStorage.setItem('wordQuicky.suffLevel',String(id));
  }
...
experimentalSuffToggle.addEventListener('change',() => {
  ...
  localStorage.setItem('wordQuicky.experimentalSuff', String(state.experimentalSuff));
  renderSettings();
  rerollVisibleSuff();
});
